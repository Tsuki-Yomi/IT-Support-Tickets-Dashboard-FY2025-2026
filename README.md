...
**[Download the .pbix file](./IT_Support_Ticket_Analysis.pbix)** (open in Power BI Desktop) · Screenshots below
...
*(add 2–4 exported PNGs of the dashboard here, e.g. the full view and a filtered view, using standard Markdown image syntax:*
